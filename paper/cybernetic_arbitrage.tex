...
\item \textbf{Opportunity generation.} Each node generates a Poisson-distributed number of coordination opportunities (mean 0.3 per node per step). An opportunity means: this node has something it could coordinate with a neighbor.
