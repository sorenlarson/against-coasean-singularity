...
\caption{Competing-world surplus trajectory (single-seed, seed 42, passive router). The rollup starts near zero (paying integration costs), overtakes the router around step 40, and reaches 34 per step while the router goes to zero. The market persists at a stable level because its low-value nodes are not worth acquiring.}
\label{fig:tipping}
\end{figure}
